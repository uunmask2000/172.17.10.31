...
class taskServer {
	...
	public function __construct() {
		...
		//$this->serv = new swoole_websocket_server('172.17.10.31', 9511);
	...
	public function onTask($serv, $task_id, $from_id, $frame) {
		...
		//echo $task_id . "\n";
		if (empty($task_id)) {
			$file = './temp/onTask_taskServer_empty.txt';
			$current = file_get_contents($file);
			$current .= "-------------------------\n";
			$current .= date("Y-m-d H:i:s") . "taskServer onTask Runing empty \n";
